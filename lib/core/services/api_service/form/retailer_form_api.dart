...
class RetailerFormApi {
  ...
  static Future<Map<String, dynamic>> createRetailer({
    ...
    try {
      final response = await http
          .post(
        Uri.parse("${ApiService.baseUrl}/retailers"),
        headers: {
          ...ApiService.headers,
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        throw Exception(_message(data, "Failed to create retailer profile"));
      }
    } on SocketException {
  ...
  static Future<Map<String, dynamic>?> getMyProfile() async {
    try {
      final response = await http
          .get(
        Uri.parse("${ApiService.baseUrl}/retailers/profile"),
        headers: {
          ...ApiService.headers,
          "Content-Type": "application/json"
        },
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception(_message(data, "Failed to load retailer profile"));
      }
    } on SocketException {
      throw Exception("No internet connection");
    } catch (e) {
