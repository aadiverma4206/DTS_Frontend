...
class _RetailerProfileState extends State<RetailerProfile> {
  ...
  Future<void> _loadProfile() async {
    ...
    try {
      final data = await RetailerApi.getRetailerProfile();
      if (!mounted) return;
      setState(() {
        profile = data ?? {};
        isLoading = false;
    ...
    return RefreshIndicator(
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            _profileCard(initial, name, shop, isActive, status),
            ...
            _infoCard(
              children: [
                ...
                _infoRow(
                  ...
                  'Drug License No',
                  (profile['drug_license_no'] ?? '').toString(),
                  _C.teal,
                  _C.tealSoft,
                ),
                _infoRow(
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                Text(
                  shop.isEmpty ? (name.isEmpty ? 'Unknown' : name) : shop,
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        const SizedBox(height: 12),
                        _box(width: 80, height: 22, radius: 10),
                      ],
                    ),
                  ),
                ],
