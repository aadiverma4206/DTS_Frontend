...
import '../../controller/retailer_info_controller.dart';
import 'retailer_info_details.dart';
...
class RetailerInfoScreen extends StatelessWidget {
  RetailerInfoScreen({super.key});
  final controller = Get.put(RetailerInfoController());
    ...
    return RefreshIndicator(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          final item = controller.filteredRetailers[index];
          return _retailerCard(item);
        },
      ),
    );
  }
  ...
  Widget _retailerCard(Map<String, dynamic> item) {
    ...
    return GestureDetector(
      onTap: () {
        ...
        Get.to(() => RetailerInfoDetailsScreen(userId: userId));
      },
      child: Container(
