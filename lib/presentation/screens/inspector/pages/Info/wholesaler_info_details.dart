...
import '../../controller/wholesaler_info_details_controller.dart';
...
class WholesalerInfoDetailsScreen extends StatelessWidget {
  final int userId;

  const WholesalerInfoDetailsScreen({super.key, required this.userId});
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(WholesalerInfoDetailsController(userId));
  ...
  Widget _buildBody(
    ...
    WholesalerInfoDetailsController controller,
    double hPad,
  ) {
    ...
    final data = controller.wholesaler;
    ...
    return RefreshIndicator(
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            _profileCard(initial, name, company, isActive, status),
  ...
  Widget _errorView(WholesalerInfoDetailsController controller) {
    return Center(
      child: Padding(
        padding: const EdgeInsets.all(24),
        child: Column(
  ...
  Widget _emptyView(WholesalerInfoDetailsController controller) {
    return Center(
      child: Column(
        mainAxisSize: MainAxisSize.min,
        children: [
          ...
          const SizedBox(height: 6),
          Text(
            'No details available for this wholesaler.',
