...
class WholesalerForm extends StatefulWidget {
  const WholesalerForm({super.key});

  @override
  State<WholesalerForm> createState() => _WholesalerFormState();
}
...
class _WholesalerFormState extends State<WholesalerForm>
  ...
  Future<void> _submitForm() async {
    ...
    if (!RegExp(r'^[0-9A-Z]{15}$').hasMatch(gstin)) {
      _showMsg('Enter a valid 15-character GSTIN', isError: true);
      return;
    }
    if (license.isEmpty) {
    ...
    try {
      ...
      if (!mounted) return;
      _showMsg(
        response['message']?.toString() ?? 'Wholesaler profile created',
        isError: false,
      );
        ...
        child: Column(
          ...
          children: [
            ...
            _field(
              label: 'Company Name',
              ctrl: _companyCtrl,
              hint: 'e.g. Sharma Pharma Pvt. Ltd.',
            ...
            _field(
              label: 'Address',
              ctrl: _addressCtrl,
              hint: 'Company registered address',
        ...
        TextField(
          ...
          decoration: InputDecoration(
            ...
            focusedBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(12),
              borderSide: const BorderSide(color: _C.teal, width: 1.8),
            ),
    ...
    return Stack(
      children: [
        Positioned(
          top: -55,
          right: -55,
          child: _circle(isTablet ? 240 : 160, _C.teal, 0.05),
        ),
        Positioned(
          bottom: -60,
          left: -40,
          child: _circle(isTablet ? 220 : 150, _C.indigo, 0.04),
        ),
      ],
    );
  }
